...
Now go to http://coexisting-angular-microfrontends.surge.sh in a browser. Click on the yellowish rectangle at the bottom right. Then click on `prefab-home`. Change the module url to http://localhost:4201/main.js. Then apply the override and reload the page. This will have change prefab-home to load from your localhost instead of from surge.sh. As you modify the code locally, it will
