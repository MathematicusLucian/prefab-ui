...
// node_modules/magic-grid/dist/magic-grid.esm.js
...
var MagicGrid = function MagicGrid2(config) {
  checkParams(config);
...
MagicGrid.prototype.setup = function setup() {
  ...
  var colWidth2 = this.colWidth();
  var numCols = Math.floor(width / colWidth2) || 1;
  var cols = [];
  ...
  var wSpace = width - numCols * colWidth2 + this.gutter;
  return { cols, wSpace };
};
...
MagicGrid.prototype.positionItems = function positionItems() {
  ...
  for (var i = 0; i < this.items.length; i++) {
    ...
    var left = col.index * colWidth2 + wSpace + "px";
...
var magic_grid_esm_default = MagicGrid;
export {
  magic_grid_esm_default as default
};
//# sourceMappingURL=magic-grid.js.map
