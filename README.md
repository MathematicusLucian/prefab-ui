...
This is my portfolio website (which I am refactoring to be more dynamic.) 
...
***Currently demonstrates utilisation of:***
- Reusable Angular standalone components
- Angular Control Flow
- SingleSpa, SystemJS, etc..
- Module Federation
- Tailwind CSS
- Storybook
- NgRx state management
- REST API calls
- Google Firebase Firestore/MongoDB
- Unit Testing (TDD)
...
![prefab](./src/assets/imgs/prefab-house.png)
...
![value stream mapping](./src/assets/imgs/value-stream-mapping.png)
