export enum AppValues {
    WEBSITE_NAME = '(GitHub: MathematicusLucian)',
    PORTFOLIO_OWNER = 'Luke Jones',
    PORTFOLIO_OWNER_POSTNOMINALS = 'MSc (Dist), CSM',
    PORTFOLIO_TAGLINE = 'The Engineer You Need',
    PORTFOLIO_JOB_TITLE = 'Software engineer and architect',
    PORTFOLIO_LANGUAGES = 'Python, Java, C#, C++, JavaScript, Angular, React, SQL, and more',
    PORTFOLIO_DEV_TYPES = 'Quant/AlgoTrading, Data Science, APIs, and UI',
    PORTFOLIO_ELEVATOR = 'Click below to see code samples (GitHub projects), my resume, my blog posts, research, video tutorials, etc..',
    PORTFOLIO_EXPERIENCE = '20+ years experience',
